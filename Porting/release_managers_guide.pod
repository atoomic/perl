...
Porters have access to the "dromedary" server (users.perl7.git.perl.org),
which has a F<public_html> directory to share files with.
(L<http://users.perl7.git.perl.org/~username/perl-5.xx.y.tar.gz>)
...
L<https://tux.nl/perl7/smoke/index.html>, L<https://perl7.test-smoke.org/>
...
itself as C<perl7.x.y>). C<perl -v> will identify itself as:
...
this purpose: F<http://users.perl7.git.perl.org/~USERNAME> maps to
...
Mail perl7-porters@perl.org to announce your new release, with a quote you prepared earlier.
...
header in your message after receiving it back via perl7-porters.
...
link in F<docs/dev/perl7/index.html> to point to your release.
...
Copy the perldelta.pod for this release into blead; for example:
 ...
 $ cd ..../blead
 $ cp -i ../5.10.x/pod/perldelta.pod pod/perl7101delta.pod  #for example
 $ git add pod/perl7101delta.pod

Don't forget to set the NAME correctly in the new file (e.g. perl7101delta
...
Based on
L<http://www.xray.mpe.mpg.de/mailing-lists/perl7-porters/2009-05/msg00608.html>,
