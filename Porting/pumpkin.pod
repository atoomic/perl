...
The mailing list perl7-porters@perl.org
...
Subscribe by sending the message (in the body of your letter)
	...
	subscribe perl7-porters

to perl7-porters-request@perl.org .
...
Perl releases produced by the members of perl7-porters are usually
...
perl7-porters. Trial releases use the new subversion number (to avoid
...
ideas in advance on perl7-porters.
...
metaconfig units:
	...
	# anonymous clone
	git clone https://github.com/perl7-metaconfig/metaconfig.git
	# or using a registered github.com identity with ssh
	git clone github.com:perl7-metaconfig/metaconfig metaconfig
...
You should definitely announce your patch on the perl7-porters list.
