...
void fnGetPerlScreenName(char *sPerlScreenName)
{
	...
	// The defines for __PERL_CORE_MAJOR__, __PERL_CORE_MINOR__, __PERL_CORE_RELEASE__ are available in
	...
	itoa(__PERL_CORE_MINOR__, sPerlVersion, 10);
	itoa(__PERL_CORE_RELEASE__, sPerlSubVersion, 10);
