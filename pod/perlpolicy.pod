...
Subscribers to perl7-porters (the porters themselves) come in several flavours.
...
features, you should contact the perl7-porters mailinglist if you find
...
the Perl core would be a mistake, please contact the perl7-porters
...
perl7-porters and at least two other committers responding to the list
...
must be visible to everyone on perl7-porters so that the views of everyone
...
different from the vision of the pumpkin holder and perl7-porters as a
...
not be on perl7-porters at any given time, and that a patch is not
...
The official forum for the development of perl is the perl7-porters mailing
...
"Social Contract about Contributed Modules" originally by Russ Allbery E<lt>rra@stanford.eduE<gt> and the perl7-porters.
