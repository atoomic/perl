...
The cpp macros C<__PERL_CORE_MAJOR__>, C<__PERL_CORE_MINOR__>, and C<PERL_SUBVERSION>
...
prior equivalent, while C<__PERL_CORE_MINOR__> and C<PERL_SUBVERSION> were
