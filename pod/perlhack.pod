...
Please check the archive of the perl7-porters list (see below) and/or
...
The perl7-porters (p5p) mailing list is where the Perl standard
...
L<http://markmail.org/search/?q=perl7-porters>.  There is also an archive at
L<http://archive.develooper.com/perl7-porters@perl.org/>.

=head2 perl-changes mailing list

The perl7-changes mailing list receives a copy of each patch that gets
submitted to the maintenance and development branches of the perl
repository.  See L<http://lists.perl.org/list/perl7-changes.html> for
...
Subscribe to perl7-porters, follow the patches and try and understand
...
maintained by the perl7-porters mailing list.
