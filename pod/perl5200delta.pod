...
C<$OLD_PERL_CORE_MINOR> was added as an alias of C<$]>.
...
C<$OLD_PERL_CORE_MINOR>, C<$OFMT>, and C<$ARRAY_BASE>.

(Actually, C<OLD_PERL_CORE_MINOR> I<does> exist, starting with this revision, but
