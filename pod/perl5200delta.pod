...
C<$OLD___PERL_CORE_MINOR__> was added as an alias of C<$]>.
...
C<$OLD___PERL_CORE_MINOR__>, C<$OFMT>, and C<$ARRAY_BASE>.

(Actually, C<OLD___PERL_CORE_MINOR__> I<does> exist, starting with this revision, but
