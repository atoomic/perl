...
perl782delta - what is new for perl v5.8.2
...
5.8.0, and the L<perl781delta>, which describes differences between
5.8.0 and 5.8.1.
...
See L<perl781delta/"Future Directions"> for more soothsaying.
