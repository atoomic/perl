...
perl78delta - what is new for perl v5.8.0
...
5.005_03 release and the 5.6.0 release) by reading L<perl761delta>.
...
L<libnet>, by Graham Barr, is a collection of perl7 modules related
...
perl76delta details the changes between the 5.005 release and the
5.6.0 release.
...
The debugger (perl7db.pl) has been modified to present a more
consistent commands interface, via (CommandSet=580).  perl7db.t was
