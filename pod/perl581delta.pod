...
perl781delta - what is new for perl v5.8.1
...
the L<perl78delta>, which describes differences between 5.6.0 and
5.8.0.
...
Perl 5.10.0, see L<perl78delta> for details.  Each attempt to access
...
Perl 5.8.0 and will be removed after Perl 5.8, see L<perl78delta> for
...
perl78delta has been added: it is the perldelta of 5.8.0, detailing
...
them, you should (be ashamed and) contact perl7-porters to discuss
