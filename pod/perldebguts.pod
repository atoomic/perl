...
=item 3
 ...
 in  @=Config::myconfig() from /dev/null:0
  ...
  in  $=Config::FETCH(ref(Config), '__PERL_CORE_MINOR__') from lib/Config.pm:574
  in  $=Config::FETCH(ref(Config), '__PERL_CORE_RELEASE__') from lib/Config.pm:574
...
=item 4
 ...
 in  @=Config::myconfig() from /dev/null:0
  ...
  in  $=Config::FETCH(ref(Config), '__PERL_CORE_MINOR__') from lib/Config.pm:574
  out $=Config::FETCH(ref(Config), '__PERL_CORE_MINOR__') from lib/Config.pm:574
  in  $=Config::FETCH(ref(Config), '__PERL_CORE_RELEASE__') from lib/Config.pm:574
