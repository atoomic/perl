...
=item 3
 ...
 in  @=Config::myconfig() from /dev/null:0
  ...
  in  $=Config::FETCH(ref(Config), 'PERL_CORE_MINOR') from lib/Config.pm:574
  in  $=Config::FETCH(ref(Config), 'PERL_CORE_RELEASE') from lib/Config.pm:574
...
=item 4
 ...
 in  @=Config::myconfig() from /dev/null:0
  ...
  in  $=Config::FETCH(ref(Config), 'PERL_CORE_MINOR') from lib/Config.pm:574
  out $=Config::FETCH(ref(Config), 'PERL_CORE_MINOR') from lib/Config.pm:574
  in  $=Config::FETCH(ref(Config), 'PERL_CORE_RELEASE') from lib/Config.pm:574
