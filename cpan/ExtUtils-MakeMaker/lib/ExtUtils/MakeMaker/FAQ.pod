...
And then set PERL5LIB to F<~/tmp/lib/perl7>.  This works well when you
...
=item "No rule to make target `/usr/lib/perl7/CORE/config.h', needed by `Makefile'"
