...
using perl7.005_03, which is available in source and binary form at
...
=item Documentation
  ...
  pod/perldelta.pod pod/perl7004delta.pod pod/perl76delta.pod
...
=item Perl Modules/Scripts
  ...
  lib/perl7db.pl        - use stdin not /dev/tty
