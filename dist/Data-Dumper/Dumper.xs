...
#if __PERL_CORE_MAJOR__ == 5 && PERL_VERSION <= 6 /* Perl 5.6 and earlier */
...
#if __PERL_CORE_MAJOR__ == 5 && PERL_VERSION > 6 && PERL_VERSION <= 15 && ! defined(utf8_to_uvchr_buf)
...
#if __PERL_CORE_MAJOR__ == 5 && PERL_VERSION < 20
...
#elif __PERL_CORE_MAJOR__ == 5 && PERL_VERSION < 11
...
# endif
	...
	if (namelen) {
		...
		c += 4;
#if __PERL_CORE_MAJOR__ == 5 && PERL_VERSION < 7
		if (i == 6 || (i == 7 && c[6] == '\0'))
#else
		if (i == 6)
#endif
...
# if !defined(PL_vtbl_vstring) && __PERL_CORE_MAJOR__ == 5 && PERL_VERSION < 17
	...
	PPCODE:
	{
		...
		if ((svp = hv_fetchs(hv, "sortkeys", FALSE))) {
                    ...
                    if (! SvTRUE(sv))
                        ...
                        style.sortkeys = sv;
                    else if (__PERL_CORE_MAJOR__ == 5 && PERL_VERSION < 8)
