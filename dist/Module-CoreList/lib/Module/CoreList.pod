...
=item C<find_version( __PERL_CORE_MINOR__ )>
...
=item C<is_core( MODULE, [ MODULE_VERSION, [ __PERL_CORE_MINOR__ ] ] )>
...
=item C<is_deprecated( MODULE, __PERL_CORE_MINOR__ )>

Available in version 2.22 and above.

Returns true if MODULE is marked as deprecated in __PERL_CORE_MINOR__.  If __PERL_CORE_MINOR__ is
...
=item C<changes_between( __PERL_CORE_MINOR__, __PERL_CORE_MINOR__ )>
