...
#   endif
    ...
    PL_patchlevel = newSVpvs("v" PERL_CORE_MINOR_STRING);
...
S_minus_v(pTHX)
{
	PerlIO * PIO_stdout;
	{
	    const char * const level_str = "v" PERL_CORE_MINOR_STRING;
	    const STRLEN level_len = sizeof("v" PERL_CORE_MINOR_STRING)-1;
#ifdef PERL_PATCHNUM
	    SV* level;
