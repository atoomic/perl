...
my $offset = 2;
{ no warnings 'once'; $NegIndex::NEGATIVE_INDICES = 1; }
...

{
    ...
    $seen{PUSH} = 0;
    my $got;
    { no warnings 'syntax'; $got = push @ary; }       # this didn't used to call PUSH at all
    is($got, 0);
    is($seen{PUSH}, 1);
    $seen{UNSHIFT} = 0;
    { no warnings 'syntax'; $got = unshift @ary; }    # this didn't used to call UNSHIFT at all
    is($got, 0);
    is($seen{UNSHIFT}, 1);
