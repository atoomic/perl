...
my $alpha;
$alpha += 1;
tryeq $T++, $alpha, 1, '+= with positive';
undef $alpha;
$alpha += -1;
tryeq $T++, $alpha, -1, '+= with negative';
undef $alpha;
$alpha += 4294967290;
tryeq $T++, $alpha, 4294967290, '+= with positive';
undef $alpha;
$alpha += -4294967290;
tryeq $T++, $alpha, -4294967290, '+= with negative';
undef $alpha;
$alpha += 4294967297;
tryeq $T++, $alpha, 4294967297, '+= with positive';
undef $alpha;
$alpha += -4294967297;
tryeq $T++, $alpha, -4294967297, '+= with negative';
...
$alpha = ($1 * 1024);
my $beta = ("$1" * 1024);
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - \$1 vs "\$1" * something\n';
$alpha = (1024 * $1);
$beta = (1024 * "$1");
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - something * \$1 vs "\$1"\n';
$alpha = ($1 + 102400000000000);
$beta = ("$1" + 102400000000000);
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - \$1 vs "\$1" + something\n';
$alpha = (102400000000000 + $1);
$beta = (102400000000000 + "$1");
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - something + \$1 vs "\$1"\n';
$alpha = ($1 - 10240000000000000);
$beta = ("$1" - 10240000000000000);
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - \$1 vs "\$1" - something\n';
$alpha = (10240000000000000 - $1);
$beta = (10240000000000000 - "$1");
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - something - \$1 vs "\$1"\n';
"976562500" =~ /(\d+)/;
$alpha = ($1 ** 2);
$beta = ("$1" ** 2);
...
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - \$1 vs "\$1" / something\n';
"10" =~ /(\d+)/;
$alpha = (97656250000000000 / $1);
$beta = (97656250000000000 / "$1");
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - something / \$1 vs "\$1"\n';
"97656250000000000" =~ /(\d+)/;
$alpha = ($1 <=> 97656250000000001);
$beta = ("$1" <=> 97656250000000001);
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - \$1 vs "\$1" <=> something\n';
$alpha = (97656250000000001 <=> $1);
$beta = (97656250000000001 <=> "$1");
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - something <=> \$1 vs "\$1"\n';
"97656250000000001" =~ /(\d+)/;
$alpha = ($1 % 97656250000000002);
$beta = ("$1" % 97656250000000002);
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - \$1 vs "\$1" % something\n';
$alpha = (97656250000000000 % $1);
$beta = (97656250000000000 % "$1");
print "not "x($alpha ne $beta), "ok ", $T++, qq ' - something % \$1 vs "\$1"\n';
